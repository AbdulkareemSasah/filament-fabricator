                                    ...
                                    <div class="fi-fo-builder-block-picker-ctn rounded-lg bg-white dark:bg-gray-900">
                                        @if ($blockPickerStyle === BlockPickerStyle::Dropdown)
                                            <x-filament-fabricator::forms.components.page-builder.dropdown-block-picker
                                                :action="$addBetweenAction" :after-item="$uuid" :columns="$blockPickerColumns" :blocks="$blockPickerBlocks"
                                        ...
                                        @elseif ($blockPickerStyle === BlockPickerStyle::Modal)
                                            <x-filament-fabricator::forms.components.page-builder.modal-block-picker
                                                ...
                                                :blocks="$blockPickerBlocks" :state-path="$statePath" :width="$blockPickerWidth">
                                                <x-slot name="trigger">
                                                    {{ $addBetweenAction }}
                                                </x-slot>
                                            </x-filament-fabricator::forms.components.page-builder.modal-block-picker>
        ...
        @if ($isAddable)
            @if ($blockPickerStyle === BlockPickerStyle::Dropdown)
                <x-filament-fabricator::forms.components.page-builder.dropdown-block-picker :action="$addAction"
                    :blocks="$blockPickerBlocks" :columns="$blockPickerColumns" :state-path="$statePath" :width="$blockPickerWidth"
